...
public class Create_stub extends ServiceStub implements Create, async_Create {
    ...
    try {
    MessageElementUtil.addMessageElementDispose(rr_param, MessageElementUtil.<short[]>packArray("velocity",new short[] {velocity}));
    MessageElementUtil.addMessageElementDispose(rr_param, MessageElementUtil.<short[]>packArray("radius",new short[] {radius}));
    ...
    return MessageElementUtil.<UnsignedBytes>packArray("return",rr_ret);
    }
