...
public class Create_skel extends ServiceSkel {
    ...
    try {
    MessageElementUtil.addMessageElementDispose(rr_param,MessageElementUtil.<int[]>packArray("DistanceTraveled",new int[] {DistanceTraveled}));
    MessageElementUtil.addMessageElementDispose(rr_param,MessageElementUtil.<int[]>packArray("AngleTraveled",new int[] {AngleTraveled}));
    rr_me=Create_skel.this.innerskel.wrappedCallbackCall("play_callback",this.endpoint,rr_param);
    return MessageElementUtil.<UnsignedBytes>unpackArray(rr_me);
    }
    finally {
    rr_param.delete();
    ...
    public String getRRType() { return "experimental.create2.Create"; }
}
